...
function to_title_case( $string ) {
     ...
     $acronyms_and_such = array(
         'pcsd', 'cte', 'vi', 'stem', 'ap', 's.t.e.m.', 's.t.e.a.m.', 'pta', 'p.t.a.', 's.t.a.r.', 'usda', 'pe', 'p.e.', 'byu', 'b.y.u.', 'uvu', 'u.v.u.', 'psd', 'act', 'ths', 'phs', 'ihs', 'cms', 'dms', 't.h.s.', 'p.h.s.', 'i.h.s.', 'c.m.s.', 'd.m.s.', 'scc', '(scc)'
     );
     $article_title_exceptions = array(
	    'One-A' => 'one-a', 'One-B' => 'one-b', 'DeAnna' => 'deanna'
     );
