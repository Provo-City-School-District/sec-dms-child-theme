<footer id="mainFooter">
			<section id="teacherAccess">
				...
				<ul class="imagelist">
				 	<li><a href="https://dixon.provo.edu/wp-login.php"><img src="https://dixon.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/web-page-login.svg" alt="" />Teacher Web Page Login</a></li>
				 	...
				 	<li><a href="https://login.frontlineeducation.com/login?signin=c4f172530351d39768e7d4ddf134db58&productId=ABSMGMT&clientId=ABSMGMT#/login"><img src="https://dixon.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/find-a-substitute.svg" alt="" />How to Schedule a Substitute</a></li>
				 	...
				 	<li class="employeelink"><a href="https://employee.provo.edu/"><img src="<?php echo get_home_url(); ?>/wp-content/themes/pcsd-2019-theme/assets/icons/pcsd-logo-website-header-branding.png" alt="" />Employee Support Website</a></li>
