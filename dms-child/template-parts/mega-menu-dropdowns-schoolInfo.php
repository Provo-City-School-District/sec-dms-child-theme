<div class="dropDownColumn">
	...
	?>
		<ul>
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/bell-schedules/">Bell Schedule</a></li>
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/calendar/">School Calendar</a></li>
            <li class="int"><a href="https://dixon.provo.edu/student-essentials/district-calendar/">District Calendar</a></li>
		</ul>
		<?php
		//checks if this template section is loading into the menu or into the sidebar/content area and assigns the proper heading
		if(is_page( 'school-information' ) || in_array( 43177, get_post_ancestors($post))){
	...
	?>
		<ul>
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/dixon-library/">Dixon Panther Library</a></li>
		</ul>
...
<div class="dropDownColumn">
	...
	?>
		...
		<ul>
			...
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/dixon-map/">School Map</a></li>
	...
	?>
		...
		<ul>
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/after-school-programs/">After School Programs</a></li>
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/reality-town-career-fair/">Reality Town</a></li>
			<li class="int"><a href="https://dixon.provo.edu/student-essentials/summer-school/">Summer Programs</a></li>
...
<div class="dropDownColumn">
	<?php
		...
		if(is_page( 'school-information' ) || in_array( 43177, get_post_ancestors($post))){
			?>
			<h2><img src="https://dixon.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/school-meals.svg" alt="" />School Meals</h2>
			<?php
		} else {
			?>
			<h3><img src="https://dixon.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/school-meals.svg" alt="" />School Meals</h3>
			<?php
		}
	?>
