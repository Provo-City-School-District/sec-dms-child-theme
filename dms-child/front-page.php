		...
		<main id="contentArea">
			...
			?>
			 <section id="announcments">
				<h1>Dixon Announcements</h1>
					 <div class="slick-wrapper">
					  <?php
					  		$args = array( 'post_type' => 'announcement' ,'posts_per_page' => 8 , 'orderby'  => array('date' => 'DESC'));
			...
			<section id="mainContent" class="postgrid newsBlog">
				<h1>Dixon News</h1>
					<?php
						...
						$the_query = new WP_Query( array( 'posts_per_page' => 18 , 'post_type'  => array('post', 'principals_message') , 'paged'  => $paged) );
						if($the_query->have_posts()) :
							while ($the_query->have_posts()) : $the_query->the_post();?>
						   		<article class="post">
